...
//
////    engine->textureRenderer = new TextureRenderer(engine->app);
//
////    engine->textureRenderer = new TextureRenderer(engine->app);
//
...
//
////    if (engine->physicsService != NULL) {
////        engine->physicsService->draw(engine->projectionMatrix);
////    }
////    engine->textureRenderer->render(engine->projectionMatrix);
//    RendererPool::getInstance()->getRenderer("circle")->render(engine->projectionMatrix);
////
////    ndk_helper::Mat4 translation = ndk_helper::Mat4::Translation(1.f, 1.f, 0.f);
////    ndk_helper::Mat4 projectionMat = ndk_helper::Mat4(engine->projectionMatrix);
////    ndk_helper::Mat4 rotationMat = ndk_helper::Mat4::RotationZ(angle);
//
////    engine->textureRenderer->render((projectionMat * translation ).Ptr());
//
////    translation = ndk_helper::Mat4::Translation(-1.f, 1.f, 0.f);
////    engine->textureRenderer->render((projectionMat * translation ).Ptr());
//
////    engine->textureRenderer->draw();
//
...
//
////    TextureRenderer textureRenderer(state);
//
